...
本章的内容主要是讲解服务将通讯的安全和集群外部访问内部服务的 jwt token 验证。
...
> 在 Istio 中，默认情况下，服务之间的通信不会被加密或进行身份验证。比如说， A 服务通过 http 请求 B 服务，流量经过 Envoy A 时，Envoy A 直接将流量发送到 Envoy B 中，流量不会进行加密处理。
...
![image-20230527090410894](images/image-20230527090410894.png)
